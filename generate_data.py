...
from  Custom_environment_persistent_surveillance_v5_v4 import UAV_UGV_Env
from scenario_generator_gaussian import scenario_gen
env = UAV_UGV_Env()
import  torch
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_size", type=int, default=10*1, help="Size of the dataset")
