...
def random_points_generator():
    ...
    if len(all_potential_points) > 1:
        random_uav_point = all_potential_points[np.random.choice(len(all_potential_points), 1, replace=False)]
        
        return random_uav_point
